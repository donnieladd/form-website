...
| 14 | Intelligent-intake architecture | 🟡 | Deterministic `routeFor()` table, no AI. Behind `CONTACT_ROUTING` env flag. | Owner | `api/contact.mjs` · `contact.html:70` · `tests/contact-api.test.js` |
